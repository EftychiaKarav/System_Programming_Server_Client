...
int Resolve_FilePath(char* path, char* output_dir){
    ...
    char* temp_path = (char*)calloc(strlen(path)+strlen(output_dir)+ 1, sizeof(char));
    memcpy(temp_path, output_dir, strlen(output_dir));
